...
categories: ["Assessibility", "Color Palettes", "web color accessibility"]
tags: ["Assessibility", "web color accessibility", "Color Palette"]
image: "./color-palette.png"
imageAlt: "Color palette example using the Learnui.design Assessible tool"
imageFigcaption: "A tool by Learnui.design for checking color assessibility and color contrast."
canonical: ""
---

**Web Color Accessibility** includes the concept of being, "[Perceivable](https://www.w3.org/TR/UNDERSTANDING-WCAG20/intro.html)". Part of this, is there must be sufficient color contract and size between elements. Follow along and see the steps I took to bring this theme within the _WCAG Guidelines_.

Imagine, as website developers, that we receive a color palette. A designer hands us a [Figma](https://www.figma.com/) or [Sketch](https://www.sketch.com/) file. Our job is to implement that design, with that color scheme into a component, or web page. Imagine a worse situation, you must come up with a design yourself? This can be a daunting task.

Whether you're implementing a design or creating a design, this is the moment that you must consider web accessibility. It is at this stage, [browser tools for checking accessibility like Axe](https://chrome.google.com/webstore/detail/axe-web-accessibility-tes/lhdoppojpmngadmnindnejefpokejbdd), check for and correct violations of the WCAG.

This blog post is for everyone who isn't [Jony Ive](https://en.wikipedia.org/wiki/Jony_Ive), [Erik Kennedy](http://erikdkennedy.com/) or a professional designer.

These are the simple steps I take to create a color scheme and design from scratch. These steps can apply to designs that you are implementing. During this process, as applied to the **Gatsby Theme Naked**, I ensure I follow web accessibility recommendations.

## Start with content and fonts / typography

I find it easier to assign colors working from actual content on a page. This includes choosing fonts, font sizes, rhythm, etc. before adding color. [Gatsby](https://www.gatsbyjs.org/) makes this easier with a [typography plugin](https://github.com/KyleAMathews/typography.js) and a selection of typography themes. I am using [a theme called Funston](https://github.com/KyleAMathews/typography.js/tree/master/packages/typography-theme-funston).

Using this plugin and a theme does a lot of the work. (I did modify the theme a bit in the `utils/typography.js` file.)

## How to create a web color accessible palette?

I create a color scheme by choosing an accent color. I try to find a color that matches the mood of my website or design. (You can see different colors and their meaning and psychology on this website: [color meaning and psychology](https://graf1x.com/color-psychology-emotion-meaning-poster/).)
...
The next part is to assign colors to each of the elements that make up a web page. The main content font color and it's background is the first consideration. Consider next, each of the main page sections such as the Header, Aside and Footer. Each of these sections could look different and use the same color scheme. To be web accessible, each of these sections [need to have sufficient contrast](https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum.html).

The details will matter. This includes button colors, button :hover, :active, and :focus states, links, link :hover and :active states, and code blocks and code highlights.

Separate to your main color scheme you have success and error messages, etc. that have their own colors. You may have additional sections. This theme, for example, has a _Sitewide message section_ and an _Email opt in section_. You must check these sections for web accessibility.

## Web color accessibility examples

Below are examples of the process I used to make these three section web accessible.
...
The Sitewide Message Section is a section that stands out from the rest of the page. This section should appear different to anyone trying to read the entire page. But the page should stay out of the way of someone skimming the page. It will need a different background color than the main content.
...
<figure>
  <Image
    src="./sitewide-before.png"
    alt="The original sitewide message"
    className=""
  />
  <figcaption>The original sitewide message.</figcaption>
</figure>
...
(This is a real Email opt in box, by the by. Go and give me your email address, and I will send you updates and articles regarding Gatsby and regarding this theme.)
...
I happen to know this has an issues. The white text on the orange button is small against the orange. I found the issue with the _WebAim Contrast Checker tool_.
...
The theme is using the [SolarizedLight theme](https://github.com/PrismJS/prism/blob/1d5047df37aacc900f8270b1c6215028f6988eb1/themes/prism-solarizedlight.css) for PrismJs for Code Blocks and Code Highlighting. The background color of the code block and code highlighting is a pale yellow. #fdf6e3. The font color is #657b83. This sits on a white background.
...
2.  Tweaking the CSS to match per the instructions from the [Gatsby Docs and PrismJs](https://www.gatsbyjs.org/packages/gatsby-remark-prismjs/).
